...
In order to support loading of multiple wallets in COVID19-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is COVID19.cpp.
...
Changes to COVID19.cpp
----------------------
COVID19.cpp is the entry point into COVID19-qt, and as such, will require some minor modifications to provide hooks for
