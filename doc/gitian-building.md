...
*Setup instructions for a gitian build of COVID19 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the COVID19
...
- [Building COVID19](#building-COVID19)
...
Clone the git repositories for COVID19 and gitian and then checkout the COVID19 version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the COVID19 repository
...
To build COVID19 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the COVID19 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/COVID19/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/forking-altcoins/COVID19
...
For example:
```bash
URL=https://github.com/crowning-/COVID19.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit COVID19=${COMMIT} --url COVID19=${URL} ../COVID19/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit COVID19=${COMMIT} --url COVID19=${URL} ../COVID19/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit COVID19=${COMMIT} --url COVID19=${URL} ../COVID19/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/COVID19-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/COVID19-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/COVID19-build.assert
```
...
[COVID19/gitian.sigs](https://github.com/forking-altcoins-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
