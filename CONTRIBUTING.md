Contributing to COVID19 Core
============================

The COVID19 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the COVID19 Core project, and is not to be
confused with overall COVID19 Network Protocol consensus changes.

Whether a pull request is merged into COVID19 Core rests with the project merge
...
Patches that change COVID19 consensus rules are considerably more involved than
...
Where a patch set proposes to change the COVID19 consensus, it must have been
...
The project leader is the release manager for each COVID19 Core release.
