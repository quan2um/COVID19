...
#ifndef COVID19_ZCOVID19TRACKER_H
#define COVID19_ZCOVID19TRACKER_H
...
public:
    CzCOVID19Tracker(std::string strWalletFile);
    ~CzCOVID19Tracker();
...
#endif //COVID19_ZCOVID19TRACKER_H
