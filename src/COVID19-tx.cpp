...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("COVID19 Core COVID19-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  COVID19-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded COVID19 transaction") + "\n" +
                               "  COVID19-tx [options] -create [commands]   " + _("Create hex-encoded COVID19 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded COVID19 transaction
