...
public:
    ...
    bool WriteZCOVID19Seed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZCOVID19Seed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZCOVID19Seed_deprecated(uint256& seed);
    bool EraseZCOVID19Seed();
    bool EraseZCOVID19Seed_deprecated();

    bool WriteZCOVID19Count(const uint32_t& nCount);
    bool ReadZCOVID19Count(uint32_t& nCount);
