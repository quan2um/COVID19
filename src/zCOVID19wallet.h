...
#ifndef COVID19_ZCOVID19WALLET_H
#define COVID19_ZCOVID19WALLET_H
...
public:
    CzCOVID19Wallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCOVID19(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCOVID19(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //COVID19_ZCOVID19WALLET_H
