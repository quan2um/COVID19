                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("COVID19 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a COVID19 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and COVID19: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About COVID19 Core"), this);
    aboutAction->setStatusTip(tr("Show information about COVID19 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for COVID19"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your COVID19 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified COVID19 addresses"));
    ...
    openAction->setStatusTip(tr("Open a COVID19: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible COVID19 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("COVID19 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to COVID19 network", "", count));
}
...
{
    QString strTitle = tr("COVID19 Core"); // default title
