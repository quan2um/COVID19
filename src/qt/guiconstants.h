...
/* COVID19 GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "COVID19"
#define QAPP_ORG_DOMAIN "COVID19.org"
#define QAPP_APP_NAME_DEFAULT "COVID19-Qt"
#define QAPP_APP_NAME_TESTNET "COVID19-Qt-testnet"
