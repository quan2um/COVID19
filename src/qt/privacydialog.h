...
public:
    ...
    void setZCOVID19ControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCOVID19_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCOVID19_clicked();
    void on_pushButtonZCOVID19Control_clicked();
