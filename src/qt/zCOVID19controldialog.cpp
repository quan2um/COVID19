...
// Copyright (c) 2017-2018 The COVID19 developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "zCOVID19controldialog.h"
#include "ui_zCOVID19controldialog.h"
...
std::set<std::string> ZCOVID19ControlDialog::setSelectedMints;
std::set<CMintMeta> ZCOVID19ControlDialog::setMints;

ZCOVID19ControlDialog::ZCOVID19ControlDialog(QWidget *parent) :
    QDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint),
    ui(new Ui::ZCOVID19ControlDialog),
    model(0)
{
    ui->setupUi(this);
    setMints.clear();
...
ZCOVID19ControlDialog::~ZCOVID19ControlDialog()
{
    delete ui;
}

void ZCOVID19ControlDialog::setModel(WalletModel *model)
{
    this->model = model;
    updateList();
}
...
void ZCOVID19ControlDialog::updateList()
{
...
void ZCOVID19ControlDialog::updateSelection(QTreeWidgetItem* item, int column)
{
...
void ZCOVID19ControlDialog::updateLabels()
{
    int64_t nAmount = 0;
    for (const CMintMeta& mint : setMints) {
    ...
    ui->labelZCOVID19_int->setText(QString::number(nAmount));
    ui->labelQuantity_int->setText(QString::number(setSelectedMints.size()));

}

std::vector<CMintMeta> ZCOVID19ControlDialog::GetSelectedMints()
{
...
void ZCOVID19ControlDialog::ButtonAllClicked()
{
    ui->treeWidget->blockSignals(true);
