...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::COVID19);
    ...
    if (!settings.contains("nAnonymizeCOVID19Amount"))
        settings.setValue("nAnonymizeCOVID19Amount", 1000);

    nAnonymizeCOVID19Amount = settings.value("nAnonymizeCOVID19Amount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeCOVID19Amount"))
        SoftSetArg("-anonymizeCOVID19amount", settings.value("nAnonymizeCOVID19Amount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in COVID19.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeCOVID19Amount:
            return QVariant(nAnonymizeCOVID19Amount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeCOVID19Amount:
            nAnonymizeCOVID19Amount = value.toInt();
            settings.setValue("nAnonymizeCOVID19Amount", nAnonymizeCOVID19Amount);
            emit anonymizeCOVID19AmountChanged(nAnonymizeCOVID19Amount);
            break;
        case CoinControlFeatures:
