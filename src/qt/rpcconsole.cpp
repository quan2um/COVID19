...
// Copyright (c) 2015-2018 The COVID19 developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCOVID19PathCustom = GetArg("-zCOVID19backuppath", "");
    ...
    if(!strzCOVID19PathCustom.empty()) {
        ui->wallet_customzCOVID19backuppath->setText(QString::fromStdString(strzCOVID19PathCustom));
        ui->wallet_customzCOVID19backuppath_label->setVisible(true);
        ui->wallet_customzCOVID19backuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCOVID19PathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the COVID19 RPC console.") + "<br>" +
