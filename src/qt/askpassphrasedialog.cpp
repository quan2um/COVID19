                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zCOVID19 || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending COVID19 because you wouldn't check it anyway.
    if (context == Context::Send_COVID19 || context == Context::Send_zCOVID19) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR COVID19</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("COVID19 will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your COVID19s from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
