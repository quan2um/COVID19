...
/** 
    ...
    ****Note - for COVID19 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of COVID19 coming in to a transaction
