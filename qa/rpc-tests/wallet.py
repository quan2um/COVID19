...
#   c) node1 mines 32 blocks, so now node 0 has 60001COVID19, node 1 has 4250COVID19, node2 has none.
#   d) node0 sends 601 COVID19 to node2, in two transactions (301 COVID19, then 300 COVID19).
